...
Matrix *list_matrix_converter(PyObject *data_list) {
...
static PyObject *matrix_list_converter(Matrix result) {
...
static PyObject *Csymnmf(PyObject *self, PyObject *args){
    ...
    Matrix *init_H = list_matrix_converter(data_list_obj1);
    Matrix *W = list_matrix_converter(data_list_obj2);
...
static PyObject *Csym(PyObject *self, PyObject *args){
    ...
    // Convert the Python list to the Matrix struct
    Matrix *converted_mat = list_matrix_converter(data_list_obj);
